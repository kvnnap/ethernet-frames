...
using InitType2 = float;
template class Matrix<InitType2>;
template Matrix<InitType2> operator*<InitType2> (InitType2, const Matrix<InitType2>&);
template std::ostream& operator<< <InitType2> (std::ostream&, const Matrix<InitType2>&);